...
// Copied verbatim from mcu/AT32F421/preset.c -- same TIM1 PWM formula
// (nextstep()'s sine-startup path is unmodified upstream code shared
// across all backends), used as a starting point pending any real
