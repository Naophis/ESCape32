...
for arg in "$@"; do
	case "$arg" in
		...
		E14|e14) STAGE="E14" ;;
		E15|e15) STAGE="E15" ;;
		E15B|e15b) STAGE="E15B" ;;
		E15C|e15c) STAGE="E15C" ;;
		E15D|e15d) STAGE="E15D" ;;
		E16|e16) STAGE="E16" ;;
		E16B|e16b) STAGE="E16B" ;;
		E16C|e16c) STAGE="E16C" ;;
		E16D|e16d) STAGE="E16D" ;;
		E16E|e16e) STAGE="E16E" ;;
		E16F|e16f) STAGE="E16F" ;;
		E17|e17) STAGE="E17" ;;
		E18|e18) STAGE="E18" ;;
		E19|e19) STAGE="E19" ;;
		E20|e20) STAGE="E20" ;;
		E20B|e20b) STAGE="E20B" ;;
		E21|e21) STAGE="E21" ;;
		E22|e22) STAGE="E22" ;;
		E23|e23) STAGE="E23" ;;
		E24|e24) STAGE="E24" ;;
